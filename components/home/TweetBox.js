        ...
        <div className={style.tweetBoxRight}>
            <form >
                ...
                <div className={style.formLowerContainer}>
                    ...
                    <button type='submit' className={`${style.submitGeneral} ${tweetMessage?style.activeSubmit:style.inactiveSubmit}` }>
                        Tweet
                    </button>
                </div>
            </form>
